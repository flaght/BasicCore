...
handler_t plugins_call_handler_read(struct server *srv, int fd, void *pd,
                                    int len);

handler_t plugins_call_handler_read_srv(struct server *srv, int fd, void *pd,
                                        int len);

handler_t plugins_call_connection(struct server *srv, int fd, void *pd,
                                  int len);

handler_t plugins_call_connection_close(struct server *srv, int fd);

handler_t plugins_call_connection_srv(struct server *srv, int fd, void *pd,
                                      int len);
...
handler_t plugins_call_handler_read_other(struct server *srv, int fd, void *pd,
                                          int len);

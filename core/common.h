...
struct plugin {
  ...
  handler_t (*handler_read_srv)(struct server *srv, int fd, void* data,
                                int len);

  handler_t (*handler_read_other)(struct server *srv, int fd, void* data,
                                  int len);
...
struct server {
  ...
  int (*add_time_task)(struct server* srv, char* id, int opcode, int time,
                       int ncount);
